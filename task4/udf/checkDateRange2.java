 ...
 */
public class checkDateRange2 extends FilterFunc {
    ...
    public Boolean exec(Tuple input) throws IOException {
        ...
        try {
           ...
           if (((emp_from_date.compareTo(manager_from_date) > 0) && emp_from_date.compareTo(manager_to_date) < 0) || emp_from_date.compareTo(manager_from_date) == 0) {
               return true;
           }
